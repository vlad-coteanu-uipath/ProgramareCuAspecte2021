...
public class CourseController extends JPanel implements Observer, ChangeListener, ActionListener {
	 ...
	 */
	 ...
	 public void update(Observable o, Object dataArg) {
		// Implementation should be ignored since this is only used for adding a CourseRecord
	...
	public static void main(String[] args) {
		...
		JScrollPane pieChartPane = new JScrollPane(pie,
				JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
				JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
		
		JSplitPane jSplitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT,
				scrollPane, pieChartPane);
		...
		constraints.gridx = 1;
		constraints.gridy = 0;
		frame.getContentPane().add(jSplitPane, constraints);
		frame.pack();
