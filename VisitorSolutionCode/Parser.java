...
public class Parser {
  ...
  public static void main(String[] args)  {
    Parser parser = new Parser("3 * 10 - 2 + 10 * 100 / 10 / 2"); // spaces are vital!!

    TreeNode node = parser.parse();

    System.out.print("PREFIX: ");
    Visitor v = new PreFixPrintVisitor();
    node.accept(v);
    System.out.println();

    System.out.print("INFIX: ");
    v = new InFixPrintVisitor();
    node.accept(v);
    System.out.println();

    //Solution
    System.out.print("EVALUATION: ");
    EvaluatorVisitor v1 = new EvaluatorVisitor();
    node.accept(v1);
